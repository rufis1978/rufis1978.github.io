	...
	var ParticleExample = function(imagePaths, config, config1, type, useParticleContainer, stepColors)
	{
		...
		loader.load(function()
		{
			...
			setInterval(()=>{
				...
				switch (cl) {
					case 1 : emitter.startColor.value = {r:randomInteger(80,255), g:255, b: 255};
					break;
					case 2 : emitter.startColor.value = {r:255, g:randomInteger(120,255), b: 255};
					break;
					case 3 : emitter.startColor.value = {r:255, g:255, b: randomInteger(180,255)};
					break;
				}
				...
				emitter.updateOwnerPos(window.innerWidth / 2, window.innerHeight*1.2 -randomInteger(0,window.innerHeight*1.2));
			},2000)
